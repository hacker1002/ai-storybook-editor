// variant-item-image-area.tsx - Image preview + thumbnail gallery + edit popover for a character variant item
...
export function VariantItemImageArea({
  ...
  return (
    <div className="flex items-start gap-3">
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute bottom-2 right-2 flex gap-2 z-20">
              ...
              <Button
                ...
                onClick={onDownload}
                disabled={isProcessing}
                aria-label="Download variant image"
              >
      ...
      {/* Hidden file input for edit reference images — must be outside PopoverContent */}
      <input
        ref={editRefInputRef}
        type="file"
      ...
      {/* Thumbnail Gallery */}
      <div className="shrink-0" role="radiogroup" aria-label="Variant image thumbnails">
        <div className="mb-2">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-3 gap-2 max-h-[360px] overflow-y-auto p-0.5">
          {sortedIllustrations.length > 0 ? (
            sortedIllustrations.map((ill) => {
              ...
              const isSelected = originalIdx === selectedIllustrationIndex;
              return (
                <button
                  key={ill.media_url}
                  role="radio"
