...
export function SketchSpreadContentArea({ spreadId }: SketchSpreadContentAreaProps) {
  ...
  const handleGenerate = useCallback(() => {
    log.info('handleGenerate', 'stub — generate endpoint TBD', { spreadId });
    toast.info('Generate — coming soon.');
  }, [spreadId]);
