...
export type EffectCategory = 'play' | 'read-along' | 'entrance' | 'emphasis' | 'exit' | 'motion-paths' | 'camera';

export type TargetItemIcon = 'image' | 'audio' | 'video' | 'textbox' | 'shape' | 'quiz' | 'auto_pic' | 'composite';
